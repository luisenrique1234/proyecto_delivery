<?php 
 ...
 <!-- segunda parte -->
    <ol class="breadcrumb">
         ...
         <li><a href="lista_cliente.php">Listado de Clientes</a></li>
  ...
  <div class="panel-dafault" style="margin-top: 10px" > <!--panel de crear --> 
         ...
         <div class="panel-heading">  
		   ...
		   <form action="php/cliente_registro.php?accion=INS2" method="POST">
  	     	 	<div class="row">
  	     	 	...
  	     	 	<div class="row">
  	     	 		<div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-lg-8 col-lg-offset-2 col-xs-12 col-xs-offset-0">
  	     	 			<div class="form-group">
  	     	 				...
  	     	 				<a href="lista_cliente.php" class="btn btn-danger">Atras</a>
