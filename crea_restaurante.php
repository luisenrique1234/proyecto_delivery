<?php 
 ...
 <!-- segunda parte -->
    <ol class="breadcrumb">
         ...
         <li><a href="lista_restaurantes.php">Listado de Restaurantes</a></li>
         <li class="active">Nuevo Restaurantes</li>
    </ol>

  <div class="panel-dafault" style="margin-top: 10px" > <!--panel de crear --> 
  	   <div class="panel-heading"> 
  	    	<h1>Nuevo Restaurantes</h1>   
  	   </div>
         <div class="panel-heading">  
  	   </div>
  	     <div class="panel-body wow bounceInLeft">
		   <form action="php/restaurantes_registro.php?accion=INS" method="POST">
  	     	 	<div class="row">
  	     	 		<div class="col-md-3 col-md-offset-2 col-sm-3 col-sm-offset-2 col-lg-3 col-lg-offset-2 col-xs-11 col-xs-offset-0">
							 ...
							 <i class="glyphicon glyphicon-user"></i>
  	     	 		 		...
  	     	 		 		<input type="text" name="Restaurantes" required="" placeholder="Restaurantes" class="form-control">
  	     	 		 	</div>
  	     	 		 </div>
  	     	 		 ...
  	     	 		 <div class="col-md-4 col-md-offset-2 col-sm-4 col-sm-offset-2 col-lg-4 col-lg-offset-1 col-xs-12 col-xs-offset-0">
  	     	 		 	<div class="form-group">
  	     	 		 		...
  	     	 		 		<input type="text" name="dir" required="" placeholder="Direccion" class="form-control">
  	     	 		 	</div>
  	     	 		 </div>
  	     	 	</div>
  	     	 		...
  	     	 		<div class="col-md-4 col-md-offset-2 col-sm-4 col-sm-offset-2 col-lg-4 col-lg-offset-0 col-xs-12 col-xs-offset-0">
  	     	 		 ...
  	     	 		 <div class="col-md-4 col-md-offset-2 col-sm-4 col-sm-offset-2 col-lg-4 col-lg-offset-2 col-xs-12 col-xs-offset-0">
							 ...
							 <i class="fas fa-map-pin"></i>
  	     	 		 		...
  	     	 		 		<input type="domiciolio" name="rnc" required="" placeholder="RNC" class="form-control">
  	     	 		 	</div>
  	     	 		 </div>
  	     	 	...
  	     	 	<div class="row">
  	     	 		<div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-lg-8 col-lg-offset-2 col-xs-12 col-xs-offset-0">
  	     	 			<div class="form-group">
  	     	 				...
  	     	 				<a href="lista_restaurantes.php" class="btn btn-danger">Atras</a>
