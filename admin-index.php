  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Proyecto Delivery</div>
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="admin-index.php">
          ...
          <a class="nav-link" href="lista_plato.php">
          <i class="fas fa-concierge-bell"></i>
          <span>Platos</span></a>

          <a class="nav-link" href="lista_pedido.php">
          <i class="fas fa-truck"></i>
          <span>Pedidos</span></a>

          <a class="nav-link" href="lista_restaurantes.php">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Cantidad de Pedidos</div>
                      <!-- numero de registro en la tabla ciente -->
                      <?php
                      include('php/conexion.php');
